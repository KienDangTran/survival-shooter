...
public class EnemyHealth : MonoBehaviour
{
	...
	public AudioClip deathAudioClip; // The sound to play when the enemy dies.

	private Animator animator; // Reference to the Animator.
	private AudioSource enemyAudioSrc; // Reference to the AudioSource 
	...
	private void Death ()
	{
		...
		enemyAudioSrc.clip = deathAudioClip;
		enemyAudioSrc.Play ();
	}
